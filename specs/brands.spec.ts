...
describe('Brands', () => {
  ...
  describe('Create brands', () => {
    ...
    afterAll(async () => {
      await controller.deleteBrandsByID(postBrand.body._id)
    })
  ...
  describe('Fetch Individual Brand', () => {
    describe('GET /brand/:id', () => {
      ...
      it('Business Logic - GET /brand/invalid_id should throw 404', async () => {
        const res = await controller.getBrandsByID("123123cds324234")
  ...
  describe('Update brands', () => {
    ...
    it('PUT /brands', async () => {
      ...
      const res = await controller.putBrandsByID(postBrand.body._id, data)
    ...
    it('PUT /brands/invalid_id', async () => {
      ...
      const res = await controller.putBrandsByID(123, data)
  ...
  describe('Delete Brands', () => {
    ...
    it('DELETE /brands', async () => {
      const res = await controller.deleteBrandsByID(postBrand.body._id)
      expect(res.statusCode).toEqual(200)
    });
    it('DELETE /brands/invalid_id', async () => {
      const res = await controller.deleteBrandsByID("1232323")
      expect(res.statusCode).toEqual(422)
